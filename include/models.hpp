...
class models {
  public:
	...
	*/
	OPTS_BOT_ALWAYS_INLINE static double calculate_implied_volatility_baw(double option_price, double S, double K, double r, double T, double q = 0.0,
		const std::string& option_type = "calls", int max_iterations = 100, double tolerance = 1e-8) {
	...
	*/
	OPTS_BOT_ALWAYS_INLINE static double barone_adesi_whaley_american_option_price(double S, double K, double T, double r, double sigma, double q = 0.0,
  ...
  protected:
	...
	*/
	OPTS_BOT_ALWAYS_INLINE static double approx_erf(double x) {
	...
	*/
	OPTS_BOT_ALWAYS_INLINE static double normal_cdf(double x) {
	...
	*/
	OPTS_BOT_ALWAYS_INLINE static double calculate_delta(double S, double K, double T, double r, double sigma, double q = 0.0, const std::string& option_type = "calls") {
		double d1 = (std::log(S / K) + (r - q + 0.5 * sigma * sigma) * T) / (sigma * std::sqrt(T));
	...
	*/
	OPTS_BOT_ALWAYS_INLINE static double calculate_gamma(double S, double K, double T, double r, double sigma, double q = 0.0, const std::string& option_type = "calls") {
		double h = 1e-4;
	...
	*/
	OPTS_BOT_ALWAYS_INLINE static double calculate_vega(double S, double K, double T, double r, double sigma, double q = 0.0, const std::string& option_type = "calls") {
		double h = 1e-4;
