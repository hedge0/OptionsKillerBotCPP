...
OPTS_BOT_ALWAYS_INLINE void write_csv(const std::string& filename, const Eigen::VectorXd& x_vals, const Eigen::VectorXd& y_vals) {
 ...
 */
OPTS_BOT_ALWAYS_INLINE bool is_nyse_open() {
 ...
 */
OPTS_BOT_ALWAYS_INLINE Eigen::VectorXd interp1d(const Eigen::VectorXd& x, const Eigen::VectorXd& xp, const Eigen::VectorXd& fp) {
 ...
 */
OPTS_BOT_ALWAYS_INLINE double calculate_rmse(const Eigen::VectorXd& y_true, const Eigen::VectorXd& y_pred) {
